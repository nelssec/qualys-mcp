...
| `get_fim_events` | What file changes happened? Summary counts (modified/created/deleted), top affected hosts, critical path alerts (/etc/passwd, /etc/shadow, /etc/sudoers, registry keys), off-hours change detection |
