...
| Tool | What it answers |
|------|----------------|
| `get_edr_events` | What endpoint threats were detected? Malware, ransomware, C2, lateral movement, suspicious processes. Summary stats, category breakdown, top affected hosts. Filter by severity, category, host, days |
